...
export const image = [
  {
    bg: overview,
    title: 'What A1 TELECOM can do for your business',
  },
];
...
export const services = [
  {
    ...
    description:
      'Why do over 5,000 travel agencies and management companies worldwide trust A1 TELECOM’s award-winning chauffeur service?',
    list1:
