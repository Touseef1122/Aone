...
export const summary = [
  ...
  },
  {
    ...
    description: `A1 TELECOM is leading the way in growing our electric class vehicle offerings, currently available for booking in select cities. Even if you don’t ride in an electric car, you can breathe easy knowing that all of our rides are 100% carbon neutral.`,
    icon: icon8,
    // icon: "ri:leaf-line",
  },
];
